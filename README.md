...
| **BABL · GEGL** | Fixed CI flaw spawning [duplicate pipelines](https://gitlab.gnome.org/GNOME/babl/-/merge_requests/87) on every commit | Cut runner **resource usage by ~50%** |
...
<h2 align="center">Contributions? Look at this game ;)</h2>
